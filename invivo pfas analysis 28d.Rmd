...
make_plot_by_sex <- function(data, summary, sex_label) {
  ...
  data <- data %>%
    mutate(Dose = factor(Dose, levels = c("Naive", "Vehicle", "1.5")))
...
print(plot_male)
ggsave(filename = "../invivo-pfas-immunotox/R input 28d/plots/bio_dr_male_28.png", plot = plot_male,
  width = plot_width,
  height =  7,
  dpi = 300,
  bg = "white")
print(plot_female)
ggsave(filename = "../invivo-pfas-immunotox/R input 28d/plots/bio_dr_feamle_28.png", plot = plot_female,
  width = plot_width,
  height =  7,
  dpi = 300,
  bg = "white")
...
plot_female <- make_plot_by_sex(data_female, summary_data_female, "Female")
print(plot_male)
ggsave(filename = "../invivo-pfas-immunotox/R input 28d/plots/tissue_dr_male.png", plot = plot_male,
  width = plot_width,
  height =  7,
  dpi = 300,
  bg = "white")
print(plot_female)
ggsave(filename = "../invivo-pfas-immunotox/R input 28d/plots/tissue_dr_feamle.png", plot = plot_female,
  width = plot_width,
  height = 7,
  dpi = 300,
  bg = "white")
...
print(p)
ggsave(filename = "../invivo-pfas-immunotox/R input 28d/plots/liver_conc.png", plot = p, width = 10, height = 5, dpi = 300,bg = "white")
...
print(p)
ggsave(filename = "../invivo-pfas-immunotox/R input 28d/plots/plasma_conc.png", plot = p, width = 10, height = 5, dpi = 300,bg = "white")
```
#Body weight
```{r}
